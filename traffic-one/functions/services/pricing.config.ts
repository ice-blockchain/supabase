import type { MetricPricing, PricingOverride, PricingStrategy, UsageMetric } from '../types/api.ts'
...
const FREE_PRICING: Record<UsageMetric, PlanPricing> = {
  EGRESS: {
    ...
    free_units: gb(5),
    per_unit_price: 0.09 / BYTES_PER_GB,
    available_in_plan: true,
    capped: true,
    unit_price_desc: '$0.09 per GB',
  },
  CACHED_EGRESS: {
  ...
  DATABASE_SIZE: {
    pricing_strategy: 'UNIT',
    free_units: mb(500),
    per_unit_price: 0.125 / BYTES_PER_GB,
    available_in_plan: true,
    capped: true,
    unit_price_desc: '$0.125 per GB',
  },
  STORAGE_SIZE: {
    pricing_strategy: 'UNIT',
    free_units: gb(1),
    per_unit_price: 0.021 / BYTES_PER_GB,
    available_in_plan: true,
    capped: true,
    unit_price_desc: '$0.021 per GB',
  },
  MONTHLY_ACTIVE_USERS: {
    pricing_strategy: 'UNIT',
    free_units: 50000,
    per_unit_price: 0.00325,
    available_in_plan: true,
    capped: true,
    unit_price_desc: '$0.00325 per MAU',
  },
  MONTHLY_ACTIVE_SSO_USERS: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 0.015,
    available_in_plan: false,
    capped: true,
    unit_price_desc: '$0.015 per MAU',
  },
  ...
  FUNCTION_INVOCATIONS: {
    ...
    free_units: 500000,
    per_unit_price: 0.000002,
    package_size: 1000000,
    package_price: 2,
    available_in_plan: true,
    capped: true,
    unit_price_desc: '$2 per million',
  },
  ...
  STORAGE_IMAGES_TRANSFORMED: {
    ...
    available_in_plan: false,
    capped: true,
    unit_price_desc: '$5 per 1000',
  },
  REALTIME_MESSAGE_COUNT: {
    pricing_strategy: 'PACKAGE',
    free_units: 2000000,
    per_unit_price: 0.0000025,
    package_size: 1000000,
    package_price: 2.5,
    available_in_plan: true,
    capped: true,
    unit_price_desc: '$2.50 per million',
  },
  ...
  COMPUTE_HOURS_XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 0.2877,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$0.2877 per hour',
  },
  COMPUTE_HOURS_2XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 0.562,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$0.562 per hour',
  },
  COMPUTE_HOURS_4XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 1.1098,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$1.1098 per hour',
  },
  COMPUTE_HOURS_8XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 2.2055,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$2.2055 per hour',
  },
  COMPUTE_HOURS_12XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 3.2877,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$3.2877 per hour',
  },
  COMPUTE_HOURS_16XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 4.3836,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$4.3836 per hour',
  },
  COMPUTE_HOURS_24XL: {
    pricing_strategy: 'UNIT',
    free_units: 0,
  ...
  DISK_SIZE_GB_HOURS_GP3: {
    pricing_strategy: 'UNIT',
    free_units: 0,
    per_unit_price: 0.000171,
    available_in_plan: false,
    capped: false,
    unit_price_desc: '$0.125 per GB-month',
  },
...
function buildPlanPricing(
  overrides: Partial<Record<UsageMetric, Partial<PlanPricing>>>,
): Record<UsageMetric, PlanPricing> {
