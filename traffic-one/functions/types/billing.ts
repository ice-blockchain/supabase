...
// Matches packages/api-types → components.schemas.TaxIdResponse. Studio's
// `useOrganizationTaxIdQuery` reads `.tax_id` off this and falls back to
// `null` when no tax ID is persisted. Keep the shape in sync with upstream.
