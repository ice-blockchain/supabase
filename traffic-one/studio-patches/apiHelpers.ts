 ...
 * We will only keep the header keys that are in this list: Accept, Authorization, Content-Type
 *
 * x-connection-encrypted is intentionally NOT forwarded in self-hosted platform mode;
 * pg-meta uses its default PG_CONNECTION when this header is absent.
 */
